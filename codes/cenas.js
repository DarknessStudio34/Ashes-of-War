   ...
   if (propor == 20.9){
     if(c == 0){
       ...
       tld20_1()
         ...
         if (mouseX > screenX * 0.825 && mouse < screenX * 0.95 && mouseY > screenY * 0.29 && mouseY < screenY * 0.463){
           c = 1.1
         }
         if (mouseX > screenX * 0.825 && mouse < screenX * 0.95 && mouseY > screenY * 0.61 && mouseY < screenY * 0.73){
           c = 1.2
         }
       } else if (c == 1.1){
           background(graphics.bg);
